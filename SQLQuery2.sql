...
ALTER TABLE employee_payroll DROP COLUMN Salary
 ...
 Phone=9764510067 ,Address='Pune', Department='FrontEnd', Deductions=2000, TaxablePay=1000, IncomeTax=2000, NetPay=25000 where name='Vaibhav'
 Update employee_payroll set 
 Phone=9988558899 ,Address='Nagpur', Department='Accounts', Deductions=3000, TaxablePay=1000, IncomeTax=3000, NetPay=33000 where name='Ankush'
 Update employee_payroll set 
 ...
 Update employee_payroll set 
 Phone=8090603020 ,Address='Chennai', Department='Backend', Deductions=1000, TaxablePay=500, IncomeTax=0, NetPay=13500 where name='Harish'
